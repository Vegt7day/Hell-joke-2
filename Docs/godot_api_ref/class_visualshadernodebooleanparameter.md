...
`bool<class_bool>`{.interpreted-text role="ref"} **default_value** = `false` `🔗<class_VisualShaderNodeBooleanParameter_property_default_value>`{.interpreted-text role="ref"}

::: rst-class
classref-property-setget
:::

- `void (No return value.)`{.interpreted-text role="abbr"} **set_default_value**(value: `bool<class_bool>`{.interpreted-text role="ref"})
- `bool<class_bool>`{.interpreted-text role="ref"} **get_default_value**()
...
`bool<class_bool>`{.interpreted-text role="ref"} **default_value_enabled** = `false` `🔗<class_VisualShaderNodeBooleanParameter_property_default_value_enabled>`{.interpreted-text role="ref"}
...
Enables usage of the `default_value<class_VisualShaderNodeBooleanParameter_property_default_value>`{.interpreted-text role="ref"}.
