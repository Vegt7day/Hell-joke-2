...
See the `HTTPRequest<class_HTTPRequest>`{.interpreted-text role="ref"} node for a higher-level alternative.

**Note:** This client only needs to connect to a host once (see `connect_to_host()<class_HTTPClient_method_connect_to_host>`{.interpreted-text role="ref"}) to send multiple requests. Because of this, methods that take URLs usually take just the part after the host instead of the full URL, as the client is already connected to a host. See `request()<class_HTTPClient_method_request>`{.interpreted-text role="ref"} for a full example and to get started.
...
- `HTTP client class <../tutorials/networking/http_client_class>`{.interpreted-text role="doc"}
...
enum **Method**: `🔗<enum_HTTPClient_Method>`{.interpreted-text role="ref"}
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_GET** = `0`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_HEAD** = `1`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_POST** = `2`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_PUT** = `3`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_DELETE** = `4`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_OPTIONS** = `5`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_TRACE** = `6`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_CONNECT** = `7`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_PATCH** = `8`
...
`Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} **METHOD_MAX** = `9`

Represents the size of the `Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"} enum.
...
enum **Status**: `🔗<enum_HTTPClient_Status>`{.interpreted-text role="ref"}
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_DISCONNECTED** = `0`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_RESOLVING** = `1`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_CANT_RESOLVE** = `2`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_CONNECTING** = `3`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_CANT_CONNECT** = `4`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_CONNECTED** = `5`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_REQUESTING** = `6`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_BODY** = `7`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_CONNECTION_ERROR** = `8`
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **STATUS_TLS_HANDSHAKE_ERROR** = `9`
...
enum **ResponseCode**: `🔗<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"}
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_CONTINUE** = `100`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_SWITCHING_PROTOCOLS** = `101`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PROCESSING** = `102`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_OK** = `200`
...
- `METHOD_GET<class_HTTPClient_constant_METHOD_GET>`{.interpreted-text role="ref"}: The resource has been fetched and is transmitted in the message body.
- `METHOD_HEAD<class_HTTPClient_constant_METHOD_HEAD>`{.interpreted-text role="ref"}: The entity headers are in the message body.
- `METHOD_POST<class_HTTPClient_constant_METHOD_POST>`{.interpreted-text role="ref"}: The resource describing the result of the action is transmitted in the message body.
- `METHOD_TRACE<class_HTTPClient_constant_METHOD_TRACE>`{.interpreted-text role="ref"}: The message body contains the request message as received by the server.
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_CREATED** = `201`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_ACCEPTED** = `202`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NON_AUTHORITATIVE_INFORMATION** = `203`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NO_CONTENT** = `204`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_RESET_CONTENT** = `205`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PARTIAL_CONTENT** = `206`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_MULTI_STATUS** = `207`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_ALREADY_REPORTED** = `208`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_IM_USED** = `226`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_MULTIPLE_CHOICES** = `300`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_MOVED_PERMANENTLY** = `301`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_FOUND** = `302`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_SEE_OTHER** = `303`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NOT_MODIFIED** = `304`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_USE_PROXY** = `305`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_SWITCH_PROXY** = `306`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_TEMPORARY_REDIRECT** = `307`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PERMANENT_REDIRECT** = `308`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_BAD_REQUEST** = `400`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_UNAUTHORIZED** = `401`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PAYMENT_REQUIRED** = `402`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_FORBIDDEN** = `403`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NOT_FOUND** = `404`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_METHOD_NOT_ALLOWED** = `405`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NOT_ACCEPTABLE** = `406`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PROXY_AUTHENTICATION_REQUIRED** = `407`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_REQUEST_TIMEOUT** = `408`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_CONFLICT** = `409`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_GONE** = `410`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_LENGTH_REQUIRED** = `411`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PRECONDITION_FAILED** = `412`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_REQUEST_ENTITY_TOO_LARGE** = `413`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_REQUEST_URI_TOO_LONG** = `414`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_UNSUPPORTED_MEDIA_TYPE** = `415`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_REQUESTED_RANGE_NOT_SATISFIABLE** = `416`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_EXPECTATION_FAILED** = `417`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_IM_A_TEAPOT** = `418`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_MISDIRECTED_REQUEST** = `421`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_UNPROCESSABLE_ENTITY** = `422`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_LOCKED** = `423`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_FAILED_DEPENDENCY** = `424`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_UPGRADE_REQUIRED** = `426`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_PRECONDITION_REQUIRED** = `428`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_TOO_MANY_REQUESTS** = `429`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_REQUEST_HEADER_FIELDS_TOO_LARGE** = `431`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_UNAVAILABLE_FOR_LEGAL_REASONS** = `451`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_INTERNAL_SERVER_ERROR** = `500`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NOT_IMPLEMENTED** = `501`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_BAD_GATEWAY** = `502`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_SERVICE_UNAVAILABLE** = `503`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_GATEWAY_TIMEOUT** = `504`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_HTTP_VERSION_NOT_SUPPORTED** = `505`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_VARIANT_ALSO_NEGOTIATES** = `506`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_INSUFFICIENT_STORAGE** = `507`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_LOOP_DETECTED** = `508`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NOT_EXTENDED** = `510`
...
`ResponseCode<enum_HTTPClient_ResponseCode>`{.interpreted-text role="ref"} **RESPONSE_NETWORK_AUTH_REQUIRED** = `511`
...
`bool<class_bool>`{.interpreted-text role="ref"} **blocking_mode_enabled** = `false` `🔗<class_HTTPClient_property_blocking_mode_enabled>`{.interpreted-text role="ref"}

::: rst-class
classref-property-setget
:::

- `void (No return value.)`{.interpreted-text role="abbr"} **set_blocking_mode**(value: `bool<class_bool>`{.interpreted-text role="ref"})
- `bool<class_bool>`{.interpreted-text role="ref"} **is_blocking_mode_enabled**()
...
`StreamPeer<class_StreamPeer>`{.interpreted-text role="ref"} **connection** `🔗<class_HTTPClient_property_connection>`{.interpreted-text role="ref"}

::: rst-class
classref-property-setget
:::

- `void (No return value.)`{.interpreted-text role="abbr"} **set_connection**(value: `StreamPeer<class_StreamPeer>`{.interpreted-text role="ref"})
- `StreamPeer<class_StreamPeer>`{.interpreted-text role="ref"} **get_connection**()
...
`int<class_int>`{.interpreted-text role="ref"} **read_chunk_size** = `65536` `🔗<class_HTTPClient_property_read_chunk_size>`{.interpreted-text role="ref"}

::: rst-class
classref-property-setget
:::

- `void (No return value.)`{.interpreted-text role="abbr"} **set_read_chunk_size**(value: `int<class_int>`{.interpreted-text role="ref"})
- `int<class_int>`{.interpreted-text role="ref"} **get_read_chunk_size**()

The size of the buffer used and maximum bytes to read per iteration. See `read_response_body_chunk()<class_HTTPClient_method_read_response_body_chunk>`{.interpreted-text role="ref"}.
...
`void (No return value.)`{.interpreted-text role="abbr"} **close**() `🔗<class_HTTPClient_method_close>`{.interpreted-text role="ref"}
...
`Error<enum_@GlobalScope_Error>`{.interpreted-text role="ref"} **connect_to_host**(host: `String<class_String>`{.interpreted-text role="ref"}, port: `int<class_int>`{.interpreted-text role="ref"} = -1, tls_options: `TLSOptions<class_TLSOptions>`{.interpreted-text role="ref"} = null) `🔗<class_HTTPClient_method_connect_to_host>`{.interpreted-text role="ref"}

Connects to a host. This needs to be done before any requests are sent.

If no `port` is specified (or `-1` is used), it is automatically set to 80 for HTTP and 443 for HTTPS. You can pass the optional `tls_options` parameter to customize the trusted certification authorities, or the common name verification when using HTTPS. See `TLSOptions.client()<class_TLSOptions_method_client>`{.interpreted-text role="ref"} and `TLSOptions.client_unsafe()<class_TLSOptions_method_client_unsafe>`{.interpreted-text role="ref"}.
...
`int<class_int>`{.interpreted-text role="ref"} **get_response_body_length**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text role="abbr"} `🔗<class_HTTPClient_method_get_response_body_length>`{.interpreted-text role="ref"}
...
`int<class_int>`{.interpreted-text role="ref"} **get_response_code**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text role="abbr"} `🔗<class_HTTPClient_method_get_response_code>`{.interpreted-text role="ref"}
...
`PackedStringArray<class_PackedStringArray>`{.interpreted-text role="ref"} **get_response_headers**() `🔗<class_HTTPClient_method_get_response_headers>`{.interpreted-text role="ref"}
...
`Dictionary<class_Dictionary>`{.interpreted-text role="ref"} **get_response_headers_as_dictionary**() `🔗<class_HTTPClient_method_get_response_headers_as_dictionary>`{.interpreted-text role="ref"}

Returns all response headers as a `Dictionary<class_Dictionary>`{.interpreted-text role="ref"}. Each entry is composed by the header name, and a `String<class_String>`{.interpreted-text role="ref"} containing the values separated by `"; "`. The casing is kept the same as the headers were received.
...
`Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} **get_status**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text role="abbr"} `🔗<class_HTTPClient_method_get_status>`{.interpreted-text role="ref"}

Returns a `Status<enum_HTTPClient_Status>`{.interpreted-text role="ref"} constant. Need to call `poll()<class_HTTPClient_method_poll>`{.interpreted-text role="ref"} in order to get status updates.
...
`bool<class_bool>`{.interpreted-text role="ref"} **has_response**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text role="abbr"} `🔗<class_HTTPClient_method_has_response>`{.interpreted-text role="ref"}
...
`bool<class_bool>`{.interpreted-text role="ref"} **is_response_chunked**() `const (This method has no side effects. It doesn't modify any of the instance's member variables.)`{.interpreted-text role="abbr"} `🔗<class_HTTPClient_method_is_response_chunked>`{.interpreted-text role="ref"}
...
This needs to be called in order to have any request processed. Check results with `get_status()<class_HTTPClient_method_get_status>`{.interpreted-text role="ref"}.
...
`String<class_String>`{.interpreted-text role="ref"} **query_string_from_dict**(fields: `Dictionary<class_Dictionary>`{.interpreted-text role="ref"}) `🔗<class_HTTPClient_method_query_string_from_dict>`{.interpreted-text role="ref"}
...
`PackedByteArray<class_PackedByteArray>`{.interpreted-text role="ref"} **read_response_body_chunk**() `🔗<class_HTTPClient_method_read_response_body_chunk>`{.interpreted-text role="ref"}
...
`Error<enum_@GlobalScope_Error>`{.interpreted-text role="ref"} **request**(method: `Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"}, url: `String<class_String>`{.interpreted-text role="ref"}, headers: `PackedStringArray<class_PackedStringArray>`{.interpreted-text role="ref"}, body: `String<class_String>`{.interpreted-text role="ref"} = \"\") `🔗<class_HTTPClient_method_request>`{.interpreted-text role="ref"}

Sends an HTTP request to the connected host with the given `method`.

The URL parameter is usually just the part after the host, so for `https://example.com/index.php`, it is `/index.php`. When sending requests to an HTTP proxy server, it should be an absolute URL. For `METHOD_OPTIONS<class_HTTPClient_constant_METHOD_OPTIONS>`{.interpreted-text role="ref"} requests, `*` is also allowed. For `METHOD_CONNECT<class_HTTPClient_constant_METHOD_CONNECT>`{.interpreted-text role="ref"} requests, it should be the authority component (`host:port`).
...
**Note:** The `body` parameter is ignored if `method` is `METHOD_GET<class_HTTPClient_constant_METHOD_GET>`{.interpreted-text role="ref"}. This is because GET methods can\'t contain request data. As a workaround, you can pass request data as a query string in the URL. See `String.uri_encode()<class_String_method_uri_encode>`{.interpreted-text role="ref"} for an example.
...
`Error<enum_@GlobalScope_Error>`{.interpreted-text role="ref"} **request_raw**(method: `Method<enum_HTTPClient_Method>`{.interpreted-text role="ref"}, url: `String<class_String>`{.interpreted-text role="ref"}, headers: `PackedStringArray<class_PackedStringArray>`{.interpreted-text role="ref"}, body: `PackedByteArray<class_PackedByteArray>`{.interpreted-text role="ref"}) `🔗<class_HTTPClient_method_request_raw>`{.interpreted-text role="ref"}
...
`void (No return value.)`{.interpreted-text role="abbr"} **set_http_proxy**(host: `String<class_String>`{.interpreted-text role="ref"}, port: `int<class_int>`{.interpreted-text role="ref"}) `🔗<class_HTTPClient_method_set_http_proxy>`{.interpreted-text role="ref"}
...
`void (No return value.)`{.interpreted-text role="abbr"} **set_https_proxy**(host: `String<class_String>`{.interpreted-text role="ref"}, port: `int<class_int>`{.interpreted-text role="ref"}) `🔗<class_HTTPClient_method_set_https_proxy>`{.interpreted-text role="ref"}
