...
JavaScriptObject is used to interact with JavaScript objects retrieved or created via `JavaScriptBridge.get_interface()<class_JavaScriptBridge_method_get_interface>`{.interpreted-text role="ref"}, `JavaScriptBridge.create_object()<class_JavaScriptBridge_method_create_object>`{.interpreted-text role="ref"}, or `JavaScriptBridge.create_callback()<class_JavaScriptBridge_method_create_callback>`{.interpreted-text role="ref"}.
